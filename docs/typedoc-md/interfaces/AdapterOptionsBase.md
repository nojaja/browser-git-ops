...
- **`AdapterOptionsBase`**
  ...
  ↳ [`GitHubAdapterOptions`](GitHubAdapterOptions.md)

  ↳ [`GitLabAdapterOptions`](GitLabAdapterOptions.md)

## Table of contents

### Properties

- [branch](AdapterOptionsBase.md#branch)
- [defaultBranch](AdapterOptionsBase.md#defaultbranch)
- [host](AdapterOptionsBase.md#host)
- [repositoryId](AdapterOptionsBase.md#repositoryid)
- [repositoryName](AdapterOptionsBase.md#repositoryname)
- [token](AdapterOptionsBase.md#token)
